...
<div class="wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link active" >
                        ...
                        <span style="font-weight: 600;"  class="active">Comment</span>
                    </a>
                </li>
                <li class="sidebar-item">
        ...
        <main class="main">
            ...
            <div class="container">
                <a href="add_comment.php" class="btn btn-primary btn-add-user">
                    <i class="fa-solid fa-plus"></i> Tambah Komentar
                </a>
                <table>
                    <thead>
                        <tr>
                        ...
                        if (!$result) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='btn-action'>
                                        <a href='edit_comment.php?id=" . $row['id'] . "' class='btn btn-edit'><i class='fa-solid fa-pen'></i></a>
                                        <a href='delete_comment.php?id=" . $row['id'] . "' class='btn btn-delete' onclick='return confirm(\"Apakah Anda yakin ingin menghapus komentar ini?\");'><i class='fa-solid fa-trash'></i></a>
                                    </td>";
                                echo "</tr>";
                            }
                        }
