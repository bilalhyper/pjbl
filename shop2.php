...
if ($category) {
    $sql = "SELECT products.*, category.category_name 
            ...
            WHERE category.category_name = '$category' AND products.id BETWEEN 11 AND 17
            ORDER BY rating DESC LIMIT 6";
} else {
    // Jika tidak ada kategori yang dipilih, tampilkan produk dengan ID antara 11 hingga 17
    $sql = "SELECT products.*, category.category_name 
            FROM products 
            LEFT JOIN category ON products.category_id = category.id
            WHERE products.id BETWEEN 11 AND 17
            ORDER BY rating DESC LIMIT 6";
}
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="shop2.php?category=Men">Men</a></li>
                            <li><a class="text-decoration-none" href="shop2.php?category=Women">Women</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="shop2.php">All</a>
                            </li>
                            <li class="list-inline-item">
                ...
                ?>
                    ...
                    <ul class="pagination pagination-lg justify-content-end">
                        ...
                        <li class="page-item disabled">
                            <a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0 " href="shop2.php" tabindex="-1">2</a>
                        </li>
                        <li class="page-item">
