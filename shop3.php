...
if ($category) {
    $sql = "SELECT products.*, category.category_name 
            ...
            WHERE category.category_name = '$category' AND products.id >= 17
            ORDER BY rating DESC LIMIT 9";
} else {
    // Jika tidak ada kategori yang dipilih, tampilkan semua produk dengan ID 8 ke atas
    $sql = "SELECT products.*, category.category_name 
            FROM products 
            LEFT JOIN category ON products.category_id = category.id
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:0815-13980-800">0815-13980-800</a>
                </div>
                <div>
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="shop3.php?category=Men">Men</a></li>
                            <li><a class="text-decoration-none" href="shop3.php?category=Women">Women</a></li>
                        </ul>
                    </li>
            ...
            <div class="col-lg-9">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="shop3.php">All</a>
                            </li>
                            <li class="list-inline-item">
                ...
                ?>
                    ...
                    <ul class="pagination pagination-lg justify-content-end">
                        <li class="page-item ">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="shop.php" >1</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark " href="shop2.php" >2</a>
                        </li>
                        <li class="page-item  disabled">
                            <a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="shop3.php"tabindex="-1">3</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="shop.php">Sneakers</a></li>
                        <li><a class="text-decoration-none" href="shop3.php">Sport shoes</a></li>
                        <li><a class="text-decoration-none" href="shop2.php">School Shoes</a></li>
