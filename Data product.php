...
<body>
    <div class="wrapper">
        ...
        <div class="sidebar-dropdown">
            <a href="Produk sneakers.php">Sneakers</a>
            <a href="Produk school.php">School</a>
            <a href="Produk sport.php">Sport</a>
        </div>
    </li>
                </li>
                <li class="sidebar-item">
        ...
        <div class="table-responsive">
            <div class="nullbar"><h1>Data Product</h1>
        </div>
        <div class="container">
                
                <div class="row">
                    <div class="col-md-4">
                        <a href="Produk Sneakers.php" class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex align-items-center">
                                    <i class="fa-solid fa-table-list icon"></i>
                                    <div>
                                        <h5 class="card-title">Sneakers</h5>
                                        <p class="stat"></p> <!-- Menampilkan jumlah user -->
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="Produk school.php" class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex align-items-center">
                                    <i class="fa-solid fa-table-list icon"></i>
                                    <div>
                    ...
                    <div class="col-md-4">
                        <a href="Produk sport.php" class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex align-items-center">
                                <i class="fa-solid fa-table-list icon"></i>
                                    <div>
